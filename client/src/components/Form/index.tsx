...
const Field = (props: FormDefs) => {
	...
	return (
		<div className='flex flex-col gap-1'>
			<label className='font-semibold' htmlFor={name}>{capitalize(name)}</label>
			<input
				id={name}
				name={name}
				type={type}
				...
				className='grow font-medium bg-cinder-100 dark:bg-cinder-1000 py-2 px-4 border-b-2 dark:border-cinder-900 placeholder-cinder-500 dark:placeholder-cinder-400'
			/>
		</div>
	);
};
